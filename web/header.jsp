...
<nav class="fixed-top py-3 mb-3 border-bottom navbar-light bg-light">
    <div class="container">
        <div class="d-flex justify-content-center align-items-center mb-lg-0 me-lg-auto text-dark text-decoration-none">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" alt="coin logo" class="bi bi-coin me-2" viewBox="0 0 16 16">
            ...
            <span class="d-flex align-items-center mb-0 mb-lg-0 small-font">
